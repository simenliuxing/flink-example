...
public class TzBankFiledAppendUdaf extends AggregateFunction<String, Tuple2<String, String>> {

  private static final Logger LOG = LoggerFactory.getLogger(TzBankFiledAppendUdaf.class);
