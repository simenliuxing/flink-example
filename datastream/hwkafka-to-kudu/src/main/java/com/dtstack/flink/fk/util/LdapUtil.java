...
import com.cloudera.impala.jdbc41.internal.slf4j.Logger;
import com.cloudera.impala.jdbc41.internal.slf4j.LoggerFactory;
...
public class LdapUtil {
  ...
  public static DirContext getLoginContext() {
    ...
    for (int i = 0; i < 5; i++) { // 验证次数
      ...
      env.put(
          Context.SECURITY_PRINCIPAL, "cn=" + account + ", ou=Level0" + i + "00," + LDAP_PRINCIPAL);
    ...
    try {
      ...
      modificationItem[0] =
          new ModificationItem(
              DirContext.REPLACE_ATTRIBUTE, new BasicAttribute("userPassword", password));
